    ...
    <div class="relative flex h-auto min-h-screen w-full flex-col items-center justify-center bg-background-light p-4 dark:bg-background-dark">
      <div class="layout-container flex h-full w-full grow flex-col items-center justify-center">
        <div class="w-full max-w-md rounded-xl bg-white p-6 shadow-sm dark:bg-card-dark sm:p-8">
          ...
          <div class="my-4">
            <p class="rounded-lg bg-red-100 p-3 text-center text-sm text-red-700 dark:bg-red-900/20 dark:text-red-300">Email hoặc mật khẩu không chính xác</p>
          </div>
          <form class="flex flex-col gap-4" onSubmit={handleLogin}>
            ...
            <button class="mt-4 flex h-12 w-full items-center justify-center rounded-lg bg-primary px-4 py-2 text-base font-bold text-white transition-colors hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:focus:ring-offset-background-dark" type="submit">
              Đăng nhập
            </button>
          </form>
